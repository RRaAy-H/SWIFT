...
#
# This code is based on Qwen3 implementation and has been modified to accommodate
# the SWIFT algorithm for speculative decoding.
#
...
""" PyTorch Qwen3 model with SWIFT modifications."""
import math
...
from transformers.models.qwen3.modeling_qwen3 import Qwen3MLP as _Qwen3MLP
from transformers.models.qwen3.modeling_qwen3 import Qwen3Attention as _Qwen3Attention
from transformers.models.qwen3.modeling_qwen3 import Qwen3Model as _Qwen3Model
...
class Qwen3Attention(_Qwen3Attention):
...
class Qwen3DecoderLayer(nn.Module):
    def __init__(self, config: Qwen3Config, layer_id=0):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = Qwen3Attention(config=config, layer_idx=layer_id)
...
class Qwen3Model(_Qwen3Model):
    ...
    def __init__(self, config: Qwen3Config):
        super(_Qwen3Model, self).__init__(config)
